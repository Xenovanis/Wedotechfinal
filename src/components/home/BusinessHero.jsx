...
import background from "../../assets/Home/backgroundbanner.png";
  ...
  return (
    ...
    >
      <div className="w-full">
        <h1 className="text-white font-Passion text-4xl sm:text-4xl lg:text-7xl xl:text-7xl font-extrabold uppercase leading-tight tracking-tight mb-4">
          WE DO TECH BETTER<br />
          WE MAKE YOUR BUSINESS
        </h1>
        <h2 className="text-white font-Passion text-7xl lg:text-8xl font-extrabold uppercase leading-tight tracking-tight mb-10">
          GROW
        </h2>

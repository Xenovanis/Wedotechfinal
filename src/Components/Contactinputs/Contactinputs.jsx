  ...
  return (
    <div className="  px-6 py-24 sm:py-32 lg:px-8 mx-50 lg:mx-100">
      ...
      <div className=" max-w-2xl ">
        <h2 className="text-5xl font-bold tracking-tight text-gray-900 xl:mx-100 lg:mx-100 sm:text-4xl text-center xl:text-start lg:text-start">Get in touch</h2>
      ...
      <form action="#" method="POST" className=" mt-16 max-w-4xl xl:mx-100 lg:mx-100 sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <Field className="flex gap-x-4 sm:col-span-2">
            ...
            Tick here if you'd like to receive marketing and insights from WeDoTech. You can unsubscribe at any time.{' '}
